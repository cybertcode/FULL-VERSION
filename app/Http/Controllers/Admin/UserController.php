...
class UserController extends BaseAdminController
{
    ...
    public function index(): View
    {
        ...
        $areas        = \App\Models\Perfil::distinct()->orderBy('area')->pluck('area')->filter()->values();
        $departamentos= \App\Models\Perfil::distinct()->orderBy('departamento')->pluck('departamento')->filter()->values();
