...
<section class="section-py landing-hero position-relative">
  ...
  <div class="container">
    <div class="hero-text-box text-center position-relative">
      <h1 class="text-primary hero-title display-6 fw-extrabold">Página en preparación</h1>
    </div>
  </div>
</section>
<!-- Mini-hero: End -->
...
<div class="container py-8" style="max-width: 960px;">
  ...
  {{-- ==================================================================
       CONTENIDO DE "Página en preparación" — edita libremente debajo de esta línea
       ================================================================== --}}
