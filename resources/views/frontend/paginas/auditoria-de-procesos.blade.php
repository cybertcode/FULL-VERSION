...
<section class="section-py landing-hero position-relative">
  ...
  <div class="container">
    <div class="hero-text-box text-center position-relative">
      <h1 class="text-primary hero-title display-6 fw-extrabold">Auditoría de procesos</h1>
    </div>
  </div>
</section>
<!-- Mini-hero: End -->
...
<div class="container py-8" style="max-width: 960px;">
  ...
  {{-- ==================================================================
       CONTENIDO DE "Auditoría de procesos" — edita libremente debajo de esta línea
       ================================================================== --}}
