<x-action-section>
  ...
  <x-slot name="content">
    ...
    <p class="card-text">
      Si es necesario, puedes cerrar todas tus demás sesiones activas en todos tus dispositivos. Algunas de tus sesiones recientes se muestran abajo; sin embargo, esta lista puede no ser exhaustiva. Si crees que tu cuenta ha sido comprometida, también deberías actualizar tu contraseña.
    </p>
        ...
        <div class="ms-2">
          ...
          <div>
            <div class="small text-body-secondary">
              ...
              <span class="text-success fw-medium">Este dispositivo</span>
              @else
    ...
    <x-dialog-modal wire:model.live="confirmingLogout">
      ...
      <x-slot name="content">
        Ingresa tu contraseña para confirmar que deseas cerrar tus demás sesiones activas en todos tus dispositivos.

        <div class="mt-3" x-data="{}"
          x-on:confirming-logout-other-browser-sessions.window="setTimeout(() => $refs.password.focus(), 250)">
          <x-input type="password" placeholder="Contraseña" x-ref="password"
