...
abstract class AdminTestCase extends TestCase
{
    ...
    protected function seedRolesAndPermissions(): void
    {
        ...
        $permissions = [
            ...
            'permissions.viewAny', 'permissions.create', 'permissions.edit', 'permissions.delete',
        ...
        $admin->syncPermissions([
            ...
            'roles.viewAny', 'roles.view', 'permissions.viewAny', 'permissions.create', 'permissions.edit',
            'settings.view',
            'activitylog.viewAny',
            'login-attempts.viewAny',
            'dashboard.view', 'dashboard.viewStats',
